                        ...
                        <div class="modal-content">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="row">
                                  <form method="POST" action="/seatbooking" v-on:submit.prevent="seatBooking()" @keydown="form.errors.clear($event.target.name)">
                                      ...
                                      <button class="btn btn-primary" :disabled="form.errors.any()">Continue
                                      </button>                                      
                                  </form>
                                </div>
